...
MATERIAIS_PADRAO = [
    ...
    },
    {
        ...
        "e_gpa": 200.0, "g_gpa": 76.9, "nu": 0.30,
        "fy_mpa": 345.0, "fu_mpa": 450.0, "rho_kg_m3": 7850.0,
        "custo_kg": 12.95,
    },
    {
        "nome": "MR250",
    ...
    },
    {
        ...
        "e_gpa": 200.0, "g_gpa": 76.9, "nu": 0.30,
        "fy_mpa": 350.0, "fu_mpa": 450.0, "rho_kg_m3": 7850.0,
        "custo_kg": 10.50,
    },
    {
        "nome": "SAC300",
        ...
        "e_gpa": 200.0, "g_gpa": 76.9, "nu": 0.30,
        "fy_mpa": 300.0, "fu_mpa": 420.0, "rho_kg_m3": 7850.0,
        "custo_kg": 9.70,
    },
    {
        "nome": "SAC350",
        ...
        "e_gpa": 200.0, "g_gpa": 76.9, "nu": 0.30,
        "fy_mpa": 350.0, "fu_mpa": 420.0, "rho_kg_m3": 7850.0,
        "custo_kg": 11.10,
    },
]
...
PERFIS_PADRAO = [
    ...
    ("L32x3.18",   "L", 32, 32, 0, 3.18, 1.92e-4, 1.60e-8, 1.60e-8, 6.47e-10, "Montante/Diagonal", "1.1/4 pol x 1/8 pol"),
    ("L38x3.18",   "L", 38, 38, 0, 3.18, 2.30e-4, 2.75e-8, 2.75e-8, 7.65e-10, "Montante/Diagonal", "1.1/2 pol x 1/8 pol"),
    ("L44x3.18",   "L", 44, 44, 0, 3.18, 2.67e-4, 4.34e-8, 4.34e-8, 8.75e-10, "Montante/Diagonal", "1.3/4 pol x 1/8 pol"),
    ("L51x3.18",   "L", 51, 51, 0, 3.18, 3.06e-4, 6.55e-8, 6.55e-8, 9.95e-10, "Montante/Diagonal", "2 pol x 1/8 pol"),
    ("L51x6.35",   "L", 51, 51, 0, 6.35, 5.81e-4, 1.20e-7, 1.20e-7, 3.95e-9,  "Montante/Diagonal", "2 pol x 1/4 pol"),
    ...
    ("RHS60x40x2.50", "RHS", 60, 40, 0, 2.50, 4.62e-4, 1.33e-7, 6.49e-8, 1.61e-7,  "Banzo/Montante", "Chapa 12"),
    ("RHS80x40x2.00", "RHS", 80, 40, 0, 2.00, 4.56e-4, 2.45e-7, 7.13e-8, 1.97e-7,  "Banzo/Montante", "Chapa 14"),
    ("RHS80x40x3.00", "RHS", 80, 40, 0, 3.00, 6.61e-4, 3.43e-7, 9.95e-8, 3.02e-7,  "Banzo/Montante", "Chapa 10"),
    ("RHS100x50x2.00", "RHS", 100, 50, 0, 2.00, 5.76e-4, 4.66e-7, 1.30e-7, 3.34e-7,  "Banzo", "Chapa 14"),
    ("RHS100x50x3.00", "RHS", 100, 50, 0, 3.00, 8.41e-4, 6.59e-7, 1.84e-7, 5.13e-7,  "Banzo", "Chapa 10"),
    ...
    ("Ue100x40x15x2.00", "Ue", 100, 40, 15, 2.00, 3.76e-4, 6.28e-7, 4.38e-8, 5.02e-10, "Banzo", "—"),
    ("Ue100x40x15x2.25", "Ue", 100, 40, 15, 2.25, 4.22e-4, 7.02e-7, 4.89e-8, 7.13e-10, "Banzo", "—"),
    ...
    with SessionLocal() as sessao:
        ...
        for (nome, fam, h, bf, d, t, A, Ix, Iy, J, uso, chapa) in PERFIS_PADRAO:
            if nome not in perfis_existentes:
                sessao.add(Perfil(
                    nome=nome, familia=fam,
                    h_mm=h, bf_mm=bf, d_mm=d, t_mm=t,
                    area_m2=A, ix_m4=Ix, iy_m4=Iy, j_m4=J,
                    uso_recomendado=uso, chapa_referencia=chapa,
                ))
